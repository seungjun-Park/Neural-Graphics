...
col2im_nd_cuda(
    ...
    // data_grad_attn_mask[attn_mask_idx] += (*data_col) * val;
    ...
    for (int32_t i = dim - 1; i >= 0; i--)
    {
        ...
        // (data_grad_offset_field + i * base_offset_field_idx)[offset_field_idx] += (*data_col) * grad_coord[i] * data_attn_mask[attn_mask_idx];
    }
