...
class BIPEDDataset(Dataset):
    def __init__(self,
        ...
        if train:
            self.edge_names = glob.glob(f'{root}/*/edge_maps/train/*/*.*')
            self.img_names = glob.glob(f'{root}/*/imgs/train/*/*.*')
        else:
            self.edge_names = glob.glob(f'{root}/*/edge_maps/test/*/*.*')
            self.img_names = glob.glob(f'{root}/*/imgs/test/*/*.*')
