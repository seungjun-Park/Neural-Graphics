...
from modules.utils import conv_nd, activation_func, group_norm, instantiate_from_config, img_to_freq, freq_to_img
from modules.vae.encoder import FEncoder
from modules.vae.decoder import FDecoder
...
class FAutoencoderKL(pl.LightningModule):
    def __init__(self,
        ...
        self.encoder = FEncoder(**enc_dec_config)
        self.decoder = FDecoder(**enc_dec_config)
